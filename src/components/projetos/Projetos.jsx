      ...
      <div className="projetos-container">
        <div className="projeto-box">
          ...
          <h3 className="project-title">Drunk&Drink</h3>
            <a href="https://github.com/ICEI-PUC-Minas-PPLES-TI/plf-es-2022-1-ti2-0924100-drunk-drink" className="projeto__button" target="_blank">Github
        ...
        <div className="projeto-box">
          ...
          <a href="https://github.com/Torugo38/Calculadora-Simples" className="projeto__button" target="_blank">Github
                        <i className="bx bx-right-arrow-alt projeto__button-icon"></i></a>
        </div>
        <div className="projeto-box">
          <img src={project3Img} alt="Project 3" className="project-img" />
          <h3 className="project-title">Portfólio</h3>
          <a href="https://github.com/Torugo38/PortifolioV2.5" className="projeto__button" target="_blank">Github
                        <i className="bx bx-right-arrow-alt projeto__button-icon"></i></a>
        </div>
      </div>
    </section>
